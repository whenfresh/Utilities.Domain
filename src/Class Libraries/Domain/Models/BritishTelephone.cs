...
public class BritishTelephone : KeyStringDictionary
{
    ...
    {
        get =>
            ContainsKey("TELEPHONE AREA CODE")
    ...
    {
        get =>
            ContainsKey("TELEPHONE DIALING CODE")
    ...
    {
        get =>
            ContainsKey("TELEPHONE LOCAL NUMBER")
    ...
    {
        get =>
            ContainsKey("TELEPHONE NUMBER GROUPS")
    ...
    {
        get =>
            ContainsKey("TELEPHONE SERVICE TYPE")
